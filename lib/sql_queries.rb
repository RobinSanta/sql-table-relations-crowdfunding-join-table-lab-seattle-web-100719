...
def selects_the_user_name_age_and_pledge_amount_for_all_pledges_alphabetized_by_name
  "SELECT name, age, SUM(amount) FROM users INNER JOIN pledges ON users.id == user_id GROUP BY name ORDER BY name ASC;"
end
...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "SELECT category, amount FROM projects INNER JOIN pledges ON projects.id == project_id WHERE category = 'music';"
end
